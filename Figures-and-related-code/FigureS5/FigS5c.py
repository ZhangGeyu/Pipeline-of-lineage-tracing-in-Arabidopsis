...
Germline_mutation = Germline_mutation[(Germline_mutation['mut_freq'] >= 0.5)&\
    (~Germline_mutation['mut_info'].isin(Hotspot_Plant2))&(~Germline_mutation['mut_info'].isin(HighFreqMut_list_886copy))][['mut_info','SampleName']]    # Remove copy mutations
Germline_mutation['SampleName_UMI'] = Germline_mutation['SampleName'] + '_progeny'
...
Parental_mutation = Parental_mutation[(~Parental_mutation['mut_info'].isin(Hotspot_Plant2))&\
    (~Parental_mutation['mut_info'].isin(HighFreqMut_list_886copy))][['pos','ref','alt','mut_info','SampleName','SampleName_UMI']]
