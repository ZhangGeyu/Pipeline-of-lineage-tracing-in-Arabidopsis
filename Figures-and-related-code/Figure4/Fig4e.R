...
tree <- read.tree('ConsensusSeq_Tree_Plant3.nwk')
...
Offspring_1 <- c('B1_P1_3_2nd','B2_6_P2_3_1st','B3_P6_1_1st',
                 'B1_P6_2_1st','B1_4_P4_3_1st','B2_6_P2_4_1st')
...
S_M_test <- ggplot(df_score, aes(x = score)) +
  ...
  labs(title = "Plant3 Cluster Progeny",x = "Parsimony Score",y = "Count") +
