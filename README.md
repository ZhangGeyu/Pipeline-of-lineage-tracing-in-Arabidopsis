...
This repository contains the analysis pipeline for lineage tracing in Arabidopsis, integrating UMIC-seq and TA-clone sequencing data to identify bona fide mutations, reconstruct cell lineage tree, analyze mutation frequencies across samples, and perform statistical analyses.
